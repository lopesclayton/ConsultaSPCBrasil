...
Select Case lngErrorCode
    Case WSAEACCES
        GetErrorDescription = "Permissão negada."
    Case WSAEADDRINUSE
        GetErrorDescription = "Endereço já em uso."
    Case WSAEADDRNOTAVAIL
        GetErrorDescription = "Não é possível atribuir o endereço solicitado."
    Case WSAEAFNOSUPPORT
        GetErrorDescription = "Address family not supported by protocol family."
    Case WSAEALREADY
        GetErrorDescription = "Operação já em andamento."
    Case WSAECONNABORTED
        GetErrorDescription = "Software causou a anulação da conexão."
    Case WSAECONNREFUSED
        GetErrorDescription = "Conexão recusada."
    Case WSAECONNRESET
    ...
    Case WSAETIMEDOUT
        GetErrorDescription = "Tempo esgotado para conexão."
    Case WSAEWOULDBLOCK
        GetErrorDescription = "Resource temporarily unavailable."
    Case WSAHOST_NOT_FOUND
        GetErrorDescription = "Host não encontrado."
    ...
    Case WSASYSNOTREADY
        GetErrorDescription = "Subsistema de rede não está disponível."
    Case WSATRY_AGAIN
